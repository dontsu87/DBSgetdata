...
(function (global) {
  ...
  function renderUserIdCell(uid) {
    ...
    var len = uid.length;
    if (len >= 25) {
      return '<div style="display: inline-block; font-size: 7.2px; font-family: Arial, sans-serif; letter-spacing: -0.3px; transform: scaleX(0.57); transform-origin: left center; white-space: nowrap;">' + escapeHtml(uid) + '</div>';
    }
    if (len >= 18) {
      return '<div style="display: inline-block; font-size: 7.8px; font-family: Arial, sans-serif; letter-spacing: -0.2px; transform: scaleX(0.75); transform-origin: left center; white-space: nowrap;">' + escapeHtml(uid) + '</div>';
    }
    if (len >= 12) {
      return '<span style="font-size: 8.5px;">' + escapeHtml(uid) + '</span>';
    }
    return '<span style="font-size: 9.5px;">' + escapeHtml(uid) + '</span>';
  }
