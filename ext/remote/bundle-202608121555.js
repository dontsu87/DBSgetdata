      ...
      for (var r = 0; r < rows.length; r++) {
        ...
        if (existingLink) {
          ...
          if (cellUserId) {
            ...
            cell.setAttribute('data-dbsext-newtab', '1');
...
(function (global) {
  ...
  var REQUIRED_RECORD_KEYS = [
    ...
    'portSharedBys', 'portSharingTos', 'landownerSettlements', 'beaconIds'
  ];
  var REQUIRED_ARRAY_KEYS = ['portSharedBys', 'portSharingTos', 'landownerSettlements', 'beaconIds'];
