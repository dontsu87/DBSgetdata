...
(function () {
  ...
  var NOTICE_ID = 'dbsext-extension-update-notice';
  var GUIDE_URL = 'https://dontsu87.github.io/DBSgetdata/ext/';
  ...
  function showNotice() {
    ...
    message.textContent = '重要：新機能を利用するには、DBS管理ポータル拡張の更新が必要です。';

    var link = document.createElement('a');
    link.href = GUIDE_URL;
    link.target = '_blank';
    link.rel = 'noopener noreferrer';
    link.textContent = '更新方法と新機能を見る';
    link.style.cssText = [
      'display:inline-block',
      'padding:8px 14px',
      'border-radius:6px',
