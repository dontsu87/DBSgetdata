...
(function (global) {
  ...
  function fitVehicleTable(table) {
    ...
    if (top >= 0) table.__dbsextVehicleTop = top;
    else top = table.__dbsextVehicleTop || 0;
    var pager = document.querySelector('.el-pagination');
    var pagerHeight = pager ? pager.getBoundingClientRect().height : 40;
    var available = Math.max(0, window.innerHeight - top - pagerHeight - 36);
