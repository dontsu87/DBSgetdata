...
(function (global) {
  ...
  function ensureStyle() {
    ...
    style.textContent =
      ...
      '[' + MODAL_ATTR + '] table{width:100%;min-width:650px;border-collapse:collapse;font-size:13px}' +
  ...
  function openModal(portId, rows) {
    ...
    ['更新日時', '運用状態', '公開', '駐輪台数制限'].forEach(function (label) { appendCell(header, 'th', label); });
