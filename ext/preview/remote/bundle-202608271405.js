...
(function (global) {
  ...
  function exportCorporateHistoriesTable() {
    if (typeof document === 'undefined') return false;
    var table = document.querySelector('.el-table__body, table.el-table__body, .el-table table, table');
    if (!table) {
    ...
    for (var i = 0; i < trs.length; i++) {
      var tr = trs[i];
      if (tr.classList && tr.classList.contains('el-table__empty-block')) continue;
