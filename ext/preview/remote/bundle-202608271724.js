...
(function (global) {
  ...
  function buildPrintViewHtml(params) {
    ...
    for (var cIdx = 0; cIdx < corporations.length; cIdx++) {
      ...
      html.push('      <img src="' + SEAL_DATA_URI + '" alt="印" style="position: absolute; right: 4px; top: 36px; width: 86px; height: 68px; pointer-events: none; opacity: 0.88; object-fit: fill;">');
      html.push('    </div>');
      html.push('  </div>');
